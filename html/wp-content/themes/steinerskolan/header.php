...
<body class="loading" <?php body_class(); ?>>
  ...
  <header>
    ...
    <button class="ham" type="menu">
      <svg class="open-menu" viewBox="0 0 13 9" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <svg class="close-menu" viewBox="0 0 10 10" fill="none" xmlns="http://www.w3.org/2000/svg">
